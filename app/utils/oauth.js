...
(function() {
  var AuthorizationView, accessToken, accessTokenExpiry, authorizeWithCode, config, db, getAccessToken, getAuthorizationUrl, getRefreshToken, httpHelper, logOut, logOutUrl, oauthRequest, promptForLogin, promptingForLogin, qs, resetAccessToken, saveRefreshToken, url;
