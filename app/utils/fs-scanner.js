...
(function() {
  var FsScanner, LeapApp, async, crypto, exec, fs, os, path, plist, registry, semver, shell;
  ...
  FsScanner = function(allowedApps) {
    if (Array.isArray(allowedApps)) {
      this._allowedApps = {};
      return allowedApps.forEach((function(_this) {
        return function(allowedApp) {
  ...
  FsScanner.prototype = {
    ...
    _scanForMacApps: function(cb) {
      ...
      return exec("find ~/Applications /Applications -maxdepth 4 -name Info.plist", (function(_this) {
    ...
    _createAppJsonFromPlistPath: function(plistPath, cb) {
      return plist.parseFile(plistPath, (function(_this) {
        return function(err, parsedPlist) {
    ...
    _scanForWindowsApps: function(cb) {
      ...
      return async.parallel(registryQueries, (function(_this) {
        return function(err, stdouts) {
          var registryChunks;
          if (err) {
            return cb(err);
          }
