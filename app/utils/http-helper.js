...
(function() {
  var Q, XHRDownloadStream, bytesToMB, checkPathEnsuringItExists, config, db, diskspace, fs, getJson, getToDisk, i18n, os, path, popup, post, qs, url, workingFile;
  ...
  checkPathEnsuringItExists = function(pathToTest) {
    ...
    if (os.platform() === 'win32') {
      ...
      try {
        ...
        mkdirErr = _error;
        console.warn("Error ensuring path exists: " + (err.stack || err));
      }
