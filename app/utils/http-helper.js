...
(function() {
  var Q, XHRDownloadStream, bytesToMB, checkPath, config, db, diskspace, fs, getJson, getToDisk, i18n, os, path, popup, post, qs, url, workingFile;
