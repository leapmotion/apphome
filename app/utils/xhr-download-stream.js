...
(function() {
  var Buffer, Q, XHRDownloadStream, events, filesize, oauth, stream, url, util;
  ...
  XHRDownloadStream.prototype.getFileSize = function() {
    var deferred, requestUrl, size, xhr, xhrstream;
    xhrstream = this;
    requestUrl = this._targetUrl;
    size = void 0;
    ...
    xhr.onload = function(evt) {
      ...
      if (size == null) {
        ...
        return deferred.resolve(xhrstream._fileSize = size);
      }
    };
