...
(function() {
  var LeapApp, MaxConsecutiveFailures, cancelAll, dequeue, enqueue, ga, installQueue, showAppropriateDownloadControl;
  ...
  enqueue = function(app, cb, skipToFront) {
    var app_name, queueData;
    app_name = app.get('name');
    if (app.get("state") === LeapApp.States.Uninstalled) {
      ga.trackEvent('apps/' + app_name + '/reinstall');
    }
