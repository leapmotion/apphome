...
(function() {
  var LeapApp, Migrations, config, db, migrate, os, path, v0_to_v1, v1_to_v2, v2_to_v3, v3_to_v4;
  ...
  */
  ...
  Migrations = [
    v0_to_v1 = function() {
      ...
      var appJson, myAppsJson, setAppType, uninstalledAppsJson, _i, _j, _len, _len1;
      setAppType = function(appJson) {
        if (appJson.urlToLaunch) {
          return appJson.appType = LeapApp.Types.WebApp;
        } else if (appJson.appId) {
          return appJson.appType = LeapApp.Types.StoreApp;
        } else if (appJson.name) {
          return appJson.appType = LeapApp.Types.LocalApp;
        }
      };
      myAppsJson = db.fetchObj(config.DbKeys.InstalledApps);
      uninstalledAppsJson = db.fetchObj(config.DbKeys.UninstalledApps);
