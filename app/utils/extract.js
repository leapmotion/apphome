...
(function() {
  var AdmZip, IgnoredWindowsFileRegex, MaxChildProcessBufferSize, Q, async, chmodRecursiveSync, exec, extractApp, fs, mv, os, path, plist, shell, unzip, unzipFile, _extractAppDmg, _extractAppZip, _unzipViaAdmZip, _unzipViaNodeUnzip, _unzipViaShell;
  ...
  _unzipViaNodeUnzip = function(src, dest, cb) {
  ...
  _unzipViaAdmZip = function(src, dest, cb) {
    var err, zip;
    try {
      zip = new AdmZip(src);
