...
(function() {
  var AdmZip, IgnoredWindowsFileRegex, MaxChildProcessBufferSize, async, exec, extractAppDmg, extractAppZip, fs, mv, os, path, plist, shell, unzip, unzipFile, unzipViaAdmZip, unzipViaNodeUnzip, unzipViaShell;
  ...
  extractAppZip = function(src, dest, shellUnzipOnly, cb) {
    ...
    return unzipFile(src, dest, shellUnzipOnly, function(err) {
      var chmodRecursiveSync, extractedFiles, moves, possibleAppDirs, topLevelDir;
