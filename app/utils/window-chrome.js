...
(function() {
  var LabModalView, MainPage, api, appWindowBindings, authorizationUtil, buildAccountMenu, buildFileMenu, buildHelpMenu, config, db, execFile, fs, i18n, maximizeWindow, mixpanel, os, paintMainPage, path, popup, rebuildMenuBar, tutorial;
