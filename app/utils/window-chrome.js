...
(function() {
  var MainPage, api, appWindowBindings, authorizationUtil, buildAccountMenu, buildFileMenu, buildHelpMenu, config, db, fs, i18n, maximizeWindow, mixpanel, os, paintMainPage, path, popup, rebuildMenuBar, tutorial;
