...
(function() {
  var LabModalView, MainPage, api, appWindowBindings, authorizationUtil, buildAccountMenu, buildFileMenu, buildHelpMenu, config, db, execFile, fs, ga, i18n, maximizeWindow, os, paintMainPage, path, popup, rebuildMenuBar, tutorial;
