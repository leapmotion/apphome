...
(function() {
  var LabModalView, MainPage, api, appWindowBindings, authorizationUtil, buildAccountMenu, buildFileMenu, buildHelpMenu, config, db, fs, i18n, maximizeWindow, mixpanel, os, paintMainPage, path, popup, rebuildMenuBar, tutorial;
    ...
    if (os.platform() === "win32") {
      ...
      helpMenu.append(new nwGui.MenuItem({
        ...
        click: function() {
          ...
          console.log(cpPath);
          return nwGui.Shell.openItem(cpPath);
        }
      }));
    }
    return new nwGui.MenuItem({
